...
variable "azurerm_az_node1" {
  type = string
}

variable "azurerm_az_node2" {
  type = string
}
...
variable "azurerm_existing_subnet_name_node0_sli" {
  description = "Azure existing subnet name for sli interface"
  type        = string
}
...
variable "azurerm_existing_subnet_name_node1_sli" {
  description = "Azure existing subnet name for sli interface"
  type        = string
}
...
variable "azurerm_existing_subnet_name_node2_sli" {
  description = "Azure existing subnet name for sli interface"
  type        = string
}
