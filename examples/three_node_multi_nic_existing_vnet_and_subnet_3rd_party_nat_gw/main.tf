locals {
  custom_tags = {
    ...
    f5xc-template = "f5xc_azure_cloud_ce_three_node_multi_nic_existing_vpc_and_subnet_3rd_party_nat_gw"
  }
}

module "f5xc_azure_cloud_ce_three_node_multi_nic_existing_vpc_and_subnet_3rd_party_nat_gw" {
  ...
  f5xc_cluster_nodes = {
    node0 = {
      ...
      existing_subnet_name_sli = var.azurerm_existing_subnet_name_node0_sli
    }
    node1 = {
      az                       = var.azurerm_az_node1
      existing_subnet_name_slo = var.azurerm_existing_subnet_name_node1_slo
      existing_subnet_name_sli = var.azurerm_existing_subnet_name_node1_sli
    }
    node2 = {
      az                       = var.azurerm_az_node2
      existing_subnet_name_slo = var.azurerm_existing_subnet_name_node2_slo
      existing_subnet_name_sli = var.azurerm_existing_subnet_name_node2_sli
    }
  }
...
output "f5xc_azure_cloud_ce_three_node_multi_nic_existing_vpc_and_subnet_3rd_party_nat_gw" {
  value = module.f5xc_azure_cloud_ce_three_node_multi_nic_existing_vpc_and_subnet_3rd_party_nat_gw
}