locals {
  custom_tags = {
    ...
    f5xc-template = "f5xc_azure_cloud_ce_single_node_single_nic_new_vpc_new_subnet_jframe_l7_osm"
  }
}

module "f5xc_azure_cloud_ce_single_node_single_nic_new_vpc_new_subnet_jframe_l7_osm" {
...
output "f5xc_azure_cloud_ce_single_node_single_nic_new_vpc_new_subnet_jframe_l7_osm" {
  value = module.f5xc_azure_cloud_ce_single_node_single_nic_new_vpc_new_subnet_jframe_l7_osm
}