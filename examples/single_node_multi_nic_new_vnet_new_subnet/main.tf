locals {
  custom_tags = {
    ...
    f5xc-template = "f5xc_azure_cloud_ce_single_node_multi_nic_new_vnet_new_subnet"
  }
}

module "f5xc_azure_cloud_ce_single_node_multi_nic_new_vnet_new_subnet" {
  ...
  f5xc_azure_az_nodes = {
    node0 = {
      ...
      f5xc_azure_vnet_sli_subnet = var.f5xc_azure_vnet_sli_subnet_node0,
...
output "f5xc_azure_cloud_ce_single_node_multi_nic_new_vnet_new_subnet" {
  value = module.f5xc_azure_cloud_ce_single_node_multi_nic_new_vnet_new_subnet
}