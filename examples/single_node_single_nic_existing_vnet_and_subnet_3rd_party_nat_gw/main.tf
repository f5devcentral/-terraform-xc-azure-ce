locals {
  custom_tags = {
    ...
    f5xc-template = "f5xc_azure_cloud_ce_single_node_multi_nic_existing_vpc_and_subnet_3rd_party_nat_gw"
  }
}

module "f5xc_azure_cloud_ce_single_node_multi_nic_existing_vpc_and_subnet_3rd_party_nat_gw" {
...
output "f5xc_azure_cloud_ce_single_node_multi_nic_existing_vpc_and_subnet_3rd_party_nat_gw" {
  value = module.f5xc_azure_cloud_ce_single_node_multi_nic_existing_vpc_and_subnet_3rd_party_nat_gw
}