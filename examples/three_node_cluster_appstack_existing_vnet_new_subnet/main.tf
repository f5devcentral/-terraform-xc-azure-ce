locals {
  custom_tags = {
    ...
    f5xc-template = "f5xc_azure_cloud_ce_three_node_appstack_single_nic_existing_vnet_new_subnet"
  }
}
...
module "f5xc_azure_cloud_ce_three_node_appstack_single_nic_existing_vnet_new_subnet" {
...
output "f5xc_azure_cloud_ce_three_node_appstack_single_nic_existing_vnet_new_subnet" {
  value = module.f5xc_azure_cloud_ce_three_node_appstack_single_nic_existing_vnet_new_subnet
}